...
const Footer = () => {
    return (
        <div
            ...
            className='w-full h-screen flex p-20 font-["FoundersGrotesk"]'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className="heading">
                    <h1 className='text-9xl uppercase -mb-8'>eye-</h1>
                    <h1 className='text-9xl uppercase -mb-8'>opening</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-9xl uppercase'>presentations</h1>
                <div className='dets flex justify-between items-end font-["NeueMontreal"]'>
                    <div>
                        <ul className='pt-10'>
                            S:
                            <li className='underline cursor-pointer'>Instagram</li>
                            <li className='underline cursor-pointer'>Behance</li>
                            <li className='underline cursor-pointer'>Facebook</li>
                            <li className='underline cursor-pointer'>Linkedin</li>
                        </ul>
                        <ul className='pt-10'>
                            L:
                            <li className='underline cursor-pointer'>202-1965 W 4th Ave</li>
                            <li className='underline cursor-pointer'>Vancouver, Canada</li>
                            <li className='underline cursor-pointer'>30 Chukarina St</li>
                            <li className='underline cursor-pointer'>Lviv, Ukraine</li>
                        </ul>
                        <ul className='pt-10'>
                            E:
                            <li className='underline cursor-pointer'>hello@ochi.design</li>
                        </ul>
                    </div>
                    <div>
                        <ul className='pt-10 pb-8'>
                            M:
                            <li className='underline cursor-pointer'>Home</li>
                            <li className='underline cursor-pointer'>Services</li>
                            <li className='underline cursor-pointer'>Our work</li>
                            <li className='underline cursor-pointer'>About us</li>
                            <li className='underline cursor-pointer'>Insights</li>
